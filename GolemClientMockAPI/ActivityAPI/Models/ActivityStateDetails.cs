...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class ActivityStateDetails : IEquatable<ActivityStateDetails>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((ActivityStateDetails)obj);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(ActivityStateDetails other)
        {
            ...
            return 
                (
                    ...
                    CurrentUsage != null &&
                    CurrentUsage.SequenceEqual(other.CurrentUsage)
                ) && 
                (
                    State == other.State ||
                    State != null &&
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + CurrentUsage.GetHashCode();
                    if (State != null)
        ...
        public static bool operator ==(ActivityStateDetails left, ActivityStateDetails right)
        {
